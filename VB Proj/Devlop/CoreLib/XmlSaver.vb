...
Namespace Core
    ...
    Public Class XmlSaver
        ...
        Public Function CompileToXml() As String
            ...
            x.WriteAttributeString("name", _manager.DesignerForm.Name)
            ...
            x.WriteStartElement("generatorsettings")
            WriteAttrDeclXml(x, _manager.ApplicationFrameworkSettings)
            x.WriteEndElement()
            ...
            x.WriteString(Newtonsoft.Json.JsonConvert.SerializeObject(_manager.UserCode))
            x.WriteEndElement()
            x.WriteEndElement()
        ...
        Public Sub WriteAttrDeclXml(x As Xml.XmlWriter, c As Object)
                ...
                If Not ((value Is Nothing AndAlso defaultVal Is Nothing) OrElse
                    ...
                    Select Case p.PropertyType.Name
                        Case "String"
                            ...
                            x.WriteString(Newtonsoft.Json.JsonConvert.SerializeObject(CStr(value)))
                            x.WriteEndElement()

                        Case "Integer", "Double", "Short", "UInteger", "UDouble",
                             "UShort", "Int16", "Int32", "Int64", "UInt16",
                        ...
                        Case Else
                            If p.PropertyType.IsEnum Then
                                ...
                                x.WriteEndElement()
                            Else
                                MsgBox(p.Name & " is not supported")
                            End If
                    End Select
                End If
            Next
